...
function Theme() {
  ...
  const getItemsByTheme = async (themeId) => {
    try {
      ...
      const response = await fetch(
        `https://zooming-integrity.railway.internal/api/admin/game/themes/${themeId}/items`,
        {
          method: "GET",
          headers: {
  ...
  const getCategoriesByTheme = async (themeId) => {
    try {
      const token = localStorage.getItem("token");
      const response = await fetch(
        `https://zooming-integrity.railway.internal/api/admin/game/themes/${themeId}/categories`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const makeGuess = async (themeId, itemName, jwtToken) => {
    ...
    const resp = await fetch("https://zooming-integrity.railway.internal/api/game/guess", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
